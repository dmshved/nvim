...
vim.api.nvim_create_autocmd("ColorScheme", {
    ...
    callback = function()
        -- classes
        vim.api.nvim_set_hl(0, "Type", { fg = "#42a692" })
        vim.api.nvim_set_hl(0, "@type.builtin", { fg = "#42a692" })
        vim.api.nvim_set_hl(0, "@type", { fg = "#42a692" })
        vim.api.nvim_set_hl(0, "@type.definition", { fg = "#42a692" })

        -- interfaces
        vim.api.nvim_set_hl(0, "@lsp.type.interface", { fg = "#b8d7a3" })

        -- variables, parameters
        vim.api.nvim_set_hl(0, "Identifier", { fg = "#87afaf" })
        vim.api.nvim_set_hl(0, "@variable", { fg = "#87afaf" })
        vim.api.nvim_set_hl(0, "@lsp.type.parameter", { fg = "#87afaf" })

        -- properties
        vim.api.nvim_set_hl(0, "@property", { fg = "#c7c7c7" })
        vim.api.nvim_set_hl(0, "@lsp.type.property.cs", { fg = "#c7c7c7" })

        -- keywords
        vim.api.nvim_set_hl(0, "@lsp.type.controlKeyword", { fg = "#5f87af" })
        vim.api.nvim_set_hl(0, "@lsp.type.keyword.cs", { fg = "#5f87af" })

        -- methods
        vim.api.nvim_set_hl(0, "@lsp.type.method.cs", { fg = "#cfc78c" })

        -- operators & punctuation
        vim.api.nvim_set_hl(0, "Delimiter", { fg = "#c7c7c7" })
        vim.api.nvim_set_hl(0, "@operator", { fg = "#c7c7c7" })
        vim.api.nvim_set_hl(0, "@punctuation.delimiter", { fg = "#c7c7c7" })
        vim.api.nvim_set_hl(0, "@punctuation.bracket", { fg = "#c7c7c7" })
        vim.api.nvim_set_hl(0, "@punctuation.special", { fg = "#c7c7c7" })
        vim.api.nvim_set_hl(0, "@lsp.type.punctuation.cs", { fg = "#c7c7c7" })

        -- xml
        vim.api.nvim_set_hl(0, "@lsp.type.class.xml", { fg = "#767676" })
        vim.api.nvim_set_hl(0, "@lsp.type.xmlDocCommentName.cs", { fg = "#767676" })
        vim.api.nvim_set_hl(0, "xmlTag", { fg = "#767676" })

        -- raw block markdown
        vim.api.nvim_set_hl(0, "@markup.raw.block.markdown", { fg = "#c7c7c7" })
    end,
})
